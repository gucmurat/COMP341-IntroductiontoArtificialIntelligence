...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        weight = [self[key] for key in self.keys()]
        return random.choices(keys, weights = weight, k = 1)[0]
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        if jailPosition == ghostPosition:
            if noisyDistance == None:
                ...
                return 0.0
        if noisyDistance == None: #the case that ghost is not in jail but observation is None.
            return 0.0
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for key,value in newPosDist.items():
                dist[key] += self.beliefs[oldPos]*value
        self.beliefs=dist
        self.beliefs.normalize()
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                #prevGhostPositions = list(self.particles[self.particles.index(oldParticle)-1])
